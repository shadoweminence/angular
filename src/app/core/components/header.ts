...
@Component({
  selector: 'app-header',
  imports: [AvatarModule, BadgeModule, MenubarModule, InputTextModule, RippleModule, Button],
  template: `
    <div class="card">
      <p-menubar [model]="items" class="cursor-pointer">
        <ng-template #start>
          <svg
            width="31"
            height="33"
        ...
        <ng-template #end>
          <div class="flex cursor-pointer items-center gap-2">
            ...
            <app-button label="Log Out" icon="pi pi-fw pi-sign-out" />
            <p-avatar
